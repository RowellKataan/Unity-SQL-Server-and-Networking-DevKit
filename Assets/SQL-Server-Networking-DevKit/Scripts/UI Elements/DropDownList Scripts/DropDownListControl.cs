...
public class DropDownListControl : ListBoxControl 
{
	...
	#region "PUBLIC FUNCTIONS"
		...
		#region "DROPDOWN LIST ITEMS"
			...
			public	override	void			SelectByValue(string		strValue, bool blnShifted = false, bool blnCtrled = false)
			{
				if (DdlListBox != null)
				{ 
					DdlListBox.SelectByValue(strValue, blnShifted, blnCtrled);
					if (DdlListBox.SelectedIndex < 0)
						SelectedTextObject.text = _strPlaceholder;
					else
						SelectedTextObject.text = DdlListBox.SelectedText;
			...
			public	override	void			SelectByValue(int				intValue, bool blnShifted = false, bool blnCtrled = false)
			{
				if (DdlListBox != null)
				{ 
					DdlListBox.SelectByValue(intValue, blnShifted, blnCtrled);
					if (DdlListBox.SelectedIndex < 0)
						SelectedTextObject.text = _strPlaceholder;
					else
						SelectedTextObject.text = DdlListBox.SelectedText;
			...
			public	override	void			SelectByText(	string		strText, bool blnShifted = false, bool blnCtrled = false)
			{
				if (DdlListBox != null)
				{ 
					DdlListBox.SelectByText(strText, blnShifted, blnCtrled);
					if (DdlListBox.SelectedIndex < 0)
						SelectedTextObject.text = _strPlaceholder;
					else
						SelectedTextObject.text = DdlListBox.SelectedText;
