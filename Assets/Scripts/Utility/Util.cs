// ===========================================================================================================
//
// Class/Library: Utilities (Static Class)
...
public class Util : MonoBehaviour 
{
	...
	#region "FILE FUNCTIONS"
		...
		{
			string strContent = "";
			string strPath		= Application.dataPath + "/" + strFileName;
			try 
			{
		...
		{
			if (!Directory.Exists(Application.dataPath + "/" + strDirectory))
				return false;
			else if (File.Exists(Application.dataPath + "/" + strDirectory + "/" + strFilename))
				return true;
			return false;
		}
